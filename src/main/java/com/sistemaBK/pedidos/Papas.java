...
public class Papas extends Item implements EditarItem {

    ArrayList<Ingrediente> ingredientes;
    ArrayList<Ingrediente> ingredientesAgregables;
    private double precio;

    public Papas(String nombre, double precio) {
        super(nombre);
    ...
    private void inicializarIngredientes() {
        ...
        ingredientesAgregables.add(new Ingrediente("Salsa BBQ", 0.5));
        ingredientesAgregables.add(new Ingrediente("Cebolla", 0.5));

        ingredientes.add(new Ingrediente("Papas Fritas", 2.0));
