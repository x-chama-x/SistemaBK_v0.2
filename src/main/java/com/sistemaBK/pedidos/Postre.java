...
public class Postre extends Item implements EditarItem {
    ...
    private void inicializarIngredientes() {
        ingredientesAgregables.add(new Ingrediente("Chocolate", 1.0));
        ingredientesAgregables.add(new Ingrediente("Frutas", 1.5));
        ingredientesAgregables.add(new Ingrediente("Nueces", 0.5));
        ingredientesAgregables.add(new Ingrediente("Caramelo", 0.5));
        ingredientesAgregables.add(new Ingrediente("Salsa de chocolate", 0.5));
        ingredientesAgregables.add(new Ingrediente("Salsa de frutilla", 0.5));
        ingredientesAgregables.add(new Ingrediente("Salsa de dulce de leche", 0.5));

        ingredientes.add(new Ingrediente("Helado", 2.0));
